...
window.getProposalTypes = function (jobTitle, jobDescription, checkBan) {
	...
	|| jobTitle.includes("supabase") || jobTitle.includes("js") || jobTitle.includes("restaurant") || jobTitle.includes("python") || jobTitle.includes("django") || jobTitle.includes("typescript") ||jobTitle.includes("css") || jobTitle.includes("frontend")) {
		if (jobDescription) {
